...
var ELEM_TO_ENTITY = {
  ...
  video: function video(tagName, element) {
    ...
    if (data.src != null) {
      return _draftJs.Entity.create('VIDEO', 'MUTABLE', data);
    }
  }
};
...
var INLINE_ELEMENTS = {
  ...
  embed: 1, i: 1, iframe: 1, img: 1, video: 1, input: 1, ins: 1, kbd: 1, keygen: 1,
...
var SPECIAL_ELEMENTS = {
  ...
  head: 1, hgroup: 1, hr: 1, iframe: 1, img: 1, video: 1, input: 1, keygen: 1, link: 1,
